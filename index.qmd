...
include-in-header:
  - text: |
      ...
      // Conditional redirect for root route only
      (function() {
        // Check if we're on the exact root path (GitHub Pages uses /IchraConnect/)
        if (window.location.pathname === '/' || window.location.pathname === '' ||
            window.location.pathname === '/IchraConnect/' || window.location.pathname === '/IchraConnect') {
          // Redirect to the external ReadMe page
          window.location.replace('https://ichra-connect.readme.io/');
        }
        // If not root path, let the page load normally
      })();
      </script>
---
